...
DATABASE_URL = "postgresql://postgres:password@localhost:5432/satellite_status"
...
def simulate_status_changes(db: Session):
    ...
    for satellite in satellites:
        # 1% de chance de mudança de status por chamada
        if random.random() < 0.01:
            satellite.status = not satellite.status
